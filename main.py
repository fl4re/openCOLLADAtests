...
parser.add_argument("--export-import-test", dest="doExportImportTest", action="store_true", help="Run export/import tests.")
parser.add_argument("--coherency-test", dest="doCoherencyTest", nargs=1, help="Run coherency test on given DAE file.")
parser.add_argument("--validation-test", dest="doValidationTest", nargs=1, help="Run schema validation test on given DAE file.")

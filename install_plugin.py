...
if get_platform() == 'windows':
	...
	mll_path = os.path.join(collada_maya_path, 'bin' + os.path.sep + 'win' + os.path.sep + 'x64' + os.path.sep + 'ReleasePlugin2015' + os.path.sep + 'COLLADAMaya.mll')
	...
	bundle_path = os.path.join(opencollada_path, 'COLLADAMaya' + os.path.sep + 'Build' + os.path.sep + 'Release 2015' + os.path.sep + 'COLLADAMaya.bundle')
